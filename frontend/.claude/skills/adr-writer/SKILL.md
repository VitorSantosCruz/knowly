...
Writes a new entry in `../knowly/DECISIONS.md` (backend) in the exact format
...
- **DO** classify the decision first, out loud, before writing:
  ...
  - Tier 3 (always ask first): touches `../knowly/VISION.md`'s undecided list,
...
- **STRICTLY PROHIBITED**: writing a Tier 3 decision into `../knowly/DECISIONS.md`
...
1. Read `../knowly/DECISIONS.md`'s "Decision-making authority" section in full —
   it is not boilerplate, it's the actual tier-classification rule.
2. Search `../knowly/DECISIONS.md`'s existing entries for the closest analog.
