...
- **DO** check `../knowly/VISION.md`'s "What's deliberately not decided yet" and
  `../knowly/DECISIONS.md`'s Tier 3 list before drafting anything that touches
...
1. Read `../knowly/VISION.md`, `PROJECT_STATUS.md` (both repos' if ambiguous which
   repo owns this), and `../knowly/DECISIONS.md` before drafting anything.
...
3. Identify every ambiguity a human PO would ask about: who triggers
   ...
   it touch anything from `../knowly/DECISIONS.md`'s Tier 3 list. Ask all of them
