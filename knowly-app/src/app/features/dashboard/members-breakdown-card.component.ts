    ...
    >
      @if (fetcher.loading()) {
        ...
        <div class="flex gap-6">
          <p data-testid="active-count" class="text-3xl font-bold text-ink-900 dark:text-white">
            {{ data.activeCount }}
          </p>
          <p data-testid="inactive-count" class="text-3xl font-bold text-ink-900 dark:text-white">
            {{ data.inactiveCount }}
          </p>
        </div>
      }
