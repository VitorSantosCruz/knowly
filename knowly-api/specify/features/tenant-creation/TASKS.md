...
- [ ] 1. Migration `V23__replace_tenant_legacy_fields_with_full_identification.sql`
      ...
      tables.
- [ ] 2. `Tenant.java`: drop the four legacy fields, add the eleven new
...
- [ ] 3. `TaxIdValidator`/`@ValidTaxId` (new
...
- [ ] 4. `CreateTenantRequestDto`/`AddressDto` (PLAN.md's "API
...
- [ ] 7. `TenantService#createTenant` rewritten to the new signature
...
- [ ] 8. `TenantController#createTenant` updated to the new DTO-based
...
- [ ] 9. Integration test pass (`TenantManagementIntegrationTest` or a
...
- [ ] 10. Full acceptance-criteria pass: re-verify every checkbox in
...
- [ ] 11. Run `./mvnw spotless:apply && ./mvnw verify` and confirm the
