 ...
 * has already been confirmed (REQ-4). No blind-index field is ever part of this DTO -- derived, not
 * client-settable. {@code countryCode} (ISO 3166-1 alpha-2) drives {@code taxId}'s
