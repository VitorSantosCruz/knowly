    ...
    void fullyPermissionedStaffIsRejectedFromCreatingAStaffUser() {
        ...
        var response =
                mockMvc.post()
                        ...
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(
                                "{\"email\":\"new-staff2@example.com\",\"profile\":{\"fullName\":\"Test User\",\"taxId\":\"52998224725\",\"countryCode\":\"BR\",\"address\":{\"addressLine1\":\"Rua Um, 100\",\"addressLine2\":\"Centro\",\"city\":\"Sao Paulo\",\"stateRegion\":\"SP\",\"postalCode\":\"01000-000\",\"countryCode\":\"BR\"},\"contacts\":[{\"type\":\"OTHER\",\"value\":\"v\",\"isPrimary\":false}]}}")
                        .exchange();
    ...
    void staffAdminCanStillCreateAStaffUser() {
        ...
        var response =
                mockMvc.post()
                        ...
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(
                                "{\"email\":\"new-staff3@example.com\",\"profile\":{\"fullName\":\"Test User\",\"taxId\":\"52998224725\",\"countryCode\":\"BR\",\"address\":{\"addressLine1\":\"Rua Um, 100\",\"addressLine2\":\"Centro\",\"city\":\"Sao Paulo\",\"stateRegion\":\"SP\",\"postalCode\":\"01000-000\",\"countryCode\":\"BR\"},\"contacts\":[{\"type\":\"OTHER\",\"value\":\"v\",\"isPrimary\":false}]}}")
                        .exchange();
