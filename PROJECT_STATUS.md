...
findings, committed. See its table row below. Nothing else is currently
queued — next conversation should propose 2-4 candidate directions per
the protocol above rather than assuming a specific next feature.
